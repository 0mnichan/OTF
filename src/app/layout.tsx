  ...
  return (
    <html lang="en">
      <body className="scanlines">
        ...
        <main className="relative z-10 mx-auto min-h-[calc(100vh-17rem)] max-w-6xl px-4 py-8">{children}</main>

        <footer className="relative z-10 mx-auto max-w-6xl px-4 pb-24 pt-6 text-center text-xs text-[var(--color-ink-faint)]">
          <p>
        ...
        <div className="fixed inset-x-0 bottom-0 z-20 border-t border-[var(--bevel-hi)] bg-[var(--color-panel-raised)]">
          <div className="mono mx-auto flex h-8 max-w-6xl items-center gap-2 overflow-hidden px-3 text-[10px] tracking-wide text-[var(--color-ink-dim)]">
